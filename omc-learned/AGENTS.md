...
- `scripts/validate-skills.sh` does **NOT** walk this directory — its `DOMAIN_DIRS` covers `coding/`, `platform-engineering/`, and `operations/`, not `omc-learned/`. Frontmatter correctness is enforced manually:
